...
function updateIndex(html) {
  ...
  // Desktop dropdown — replace inner content (the grid block)
  ...
  // Mobile dropdown — replace nested ul under "Services" link
...
console.log(`Updated ${changed} files. Skipped (no dropdown match): ${skipped.length}`);
